...
function click_handler(event) {
	...
	jQuery(this).html("<img src = '{% static "images/loading-indicator.gif" %}' class = 'loader' /> " + jQuery(this).html());
...
jQuery("document").ready(function () {
	...
	jQuery("#nav-menu li.active a[href='" + tab_id + "']").html("<img src = '{% static "images/loading_indicator.gif" %}' class = 'loader' /> " + jQuery("#nav-menu li a[href='" + tab_id + "']").html());
