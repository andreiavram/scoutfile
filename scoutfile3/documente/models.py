...
class DecizieCotizatie(Decizie):
    ...
    def get_package_for_centru_local(cls, centru_local=None, trimestru=None, social=False):
        ...
        valori_implicite = {"local": VALOARE_IMPLICITA_COTIZATIE_LOCAL,
                            "national": VALOARE_IMPLICITA_COTIZATIE_NATIONAL,
                            "local-social": VALOARE_IMPLICITA_COTIZATIE_LOCAL_SOCIAL,
                            "national-social": VALOARE_IMPLICITA_COTIZATIE_NATIONAL_SOCIAL}
        cuantum = {}
