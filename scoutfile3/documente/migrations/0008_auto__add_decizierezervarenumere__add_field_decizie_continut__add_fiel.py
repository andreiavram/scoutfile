...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DecizieRezervareNumere'
        db.create_table('documente_decizierezervarenumere', (
            ('decizie_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documente.Decizie'], unique=True, primary_key=True)),
            ('tip_rezervare', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('automat', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('numar_inceput', self.gf('django.db.models.fields.IntegerField')()),
            ('numar_sfarsit', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('serie', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('documente', ['DecizieRezervareNumere'])

        # Adding field 'Decizie.continut'
        db.add_column('documente_decizie', 'continut',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Decizie.centru_local'
        db.add_column('documente_decizie', 'centru_local',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['structuri.CentruLocal']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DecizieRezervareNumere'
        db.delete_table('documente_decizierezervarenumere')

        # Deleting field 'Decizie.continut'
        db.delete_column('documente_decizie', 'continut')

        # Deleting field 'Decizie.centru_local'
        db.delete_column('documente_decizie', 'centru_local_id')
