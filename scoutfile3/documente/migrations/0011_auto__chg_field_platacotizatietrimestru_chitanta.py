...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlataCotizatieTrimestru.chitanta'
        db.alter_column('documente_platacotizatietrimestru', 'chitanta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.ChitantaCotizatie'], null=True))

    def backwards(self, orm):

        # Changing field 'PlataCotizatieTrimestru.chitanta'
        db.alter_column('documente_platacotizatietrimestru', 'chitanta_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['documente.ChitantaCotizatie']))
