...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentCotizatieSociala'
        db.create_table('documente_documentcotizatiesociala', (
            ('document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documente.Document'], unique=True, primary_key=True)),
            ('nume_parinte', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('motiv', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
            ('este_valabil', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('documente', ['DocumentCotizatieSociala'])

        # Adding model 'SerieDocument'
        db.create_table('documente_seriedocument', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cod_unic', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('numar_inceput', self.gf('django.db.models.fields.IntegerField')()),
            ('numar_sfarsit', self.gf('django.db.models.fields.IntegerField')()),
            ('numar_curent', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('document_referinta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.Document'], null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('deschisa', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('documente', ['SerieDocument'])

        # Adding model 'PlataCotizatieTrimestru'
        db.create_table('documente_platacotizatietrimestru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trimestru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.Trimestru'])),
            ('partial', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('final', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('suma', self.gf('django.db.models.fields.FloatField')()),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
            ('chitanta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.ChitantaCotizatie'])),
            ('tip_inregistrare', self.gf('django.db.models.fields.CharField')(default='normal', max_length=255)),
        ))
        db.send_create_signal('documente', ['PlataCotizatieTrimestru'])

        # Adding model 'Decizie'
        db.create_table('documente_decizie', (
            ('document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documente.Document'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('documente', ['Decizie'])

        # Adding model 'DecizieCotizatie'
        db.create_table('documente_deciziecotizatie', (
            ('decizie_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documente.Decizie'], unique=True, primary_key=True)),
            ('cuantum', self.gf('django.db.models.fields.FloatField')()),
            ('categorie', self.gf('django.db.models.fields.CharField')(default='normal', max_length=255)),
        ))
        db.send_create_signal('documente', ['DecizieCotizatie'])

        # Adding field 'AsociereDocument.document_ctype'
        db.add_column('documente_asocieredocument', 'document_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='asocierdj ', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Document.data_inregistrare'
        db.add_column('documente_document', 'data_inregistrare',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TipAsociereDocument.slug'
        db.add_column('documente_tipasocieredocument', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255),
                      keep_default=False)

        # Deleting field 'Trimestru.ordine_global'
        db.delete_column('documente_trimestru', 'ordine_global')

        # Deleting field 'Trimestru.date_sfarsit'
        db.delete_column('documente_trimestru', 'date_sfarsit')

        # Deleting field 'Trimestru.ordine_local'
        db.delete_column('documente_trimestru', 'ordine_local')

        # Adding field 'Trimestru.data_sfarsit'
        db.add_column('documente_trimestru', 'data_sfarsit',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'Trimestru.ordine_locala'
        db.add_column('documente_trimestru', 'ordine_locala',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Trimestru.ordine_globala'
        db.add_column('documente_trimestru', 'ordine_globala',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DocumentCotizatieSociala'
        db.delete_table('documente_documentcotizatiesociala')

        # Deleting model 'SerieDocument'
        db.delete_table('documente_seriedocument')

        # Deleting model 'PlataCotizatieTrimestru'
        db.delete_table('documente_platacotizatietrimestru')

        # Deleting model 'Decizie'
        db.delete_table('documente_decizie')

        # Deleting model 'DecizieCotizatie'
        db.delete_table('documente_deciziecotizatie')

        # Deleting field 'AsociereDocument.document_ctype'
        db.delete_column('documente_asocieredocument', 'document_ctype_id')

        # Deleting field 'Document.data_inregistrare'
        db.delete_column('documente_document', 'data_inregistrare')

        # Deleting field 'TipAsociereDocument.slug'
        db.delete_column('documente_tipasocieredocument', 'slug')

        # Adding field 'Trimestru.ordine_global'
        db.add_column('documente_trimestru', 'ordine_global',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Trimestru.date_sfarsit'
        db.add_column('documente_trimestru', 'date_sfarsit',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'Trimestru.ordine_local'
        db.add_column('documente_trimestru', 'ordine_local',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Trimestru.data_sfarsit'
        db.delete_column('documente_trimestru', 'data_sfarsit')

        # Deleting field 'Trimestru.ordine_locala'
        db.delete_column('documente_trimestru', 'ordine_locala')

        # Deleting field 'Trimestru.ordine_globala'
        db.delete_column('documente_trimestru', 'ordine_globala')
    ...
    models = {
        ...
        'documente.asocieredocument': {
            ...
            'document_ctype': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'asocierdj '", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'documente.chitanta': {
            ...
            'numar': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'documente.platacotizatietrimestru': {
            ...
            'chitanta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['documente.ChitantaCotizatie']"}),
        ...
        'documente.seriedocument': {
            'Meta': {'object_name': 'SerieDocument'},
            'cod_unic': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'deschisa': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'document_referinta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['documente.Document']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numar_curent': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numar_inceput': ('django.db.models.fields.IntegerField', [], {}),
            'numar_sfarsit': ('django.db.models.fields.IntegerField', [], {}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
