...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentCotizatieSociala.valabilitate_start'
        db.add_column('documente_documentcotizatiesociala', 'valabilitate_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 28, 0, 0)),
                      keep_default=False)

        # Adding field 'DocumentCotizatieSociala.valabilitate_end'
        db.add_column('documente_documentcotizatiesociala', 'valabilitate_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentCotizatieSociala.valabilitate_start'
        db.delete_column('documente_documentcotizatiesociala', 'valabilitate_start')

        # Deleting field 'DocumentCotizatieSociala.valabilitate_end'
        db.delete_column('documente_documentcotizatiesociala', 'valabilitate_end')
