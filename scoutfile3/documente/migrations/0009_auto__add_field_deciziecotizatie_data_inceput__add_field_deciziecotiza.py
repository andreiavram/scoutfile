...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DecizieCotizatie.data_inceput'
        db.add_column('documente_deciziecotizatie', 'data_inceput',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 13, 0, 0)),
                      keep_default=False)

        # Adding field 'DecizieCotizatie.data_sfarsit'
        db.add_column('documente_deciziecotizatie', 'data_sfarsit',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DecizieCotizatie.data_inceput'
        db.delete_column('documente_deciziecotizatie', 'data_inceput')

        # Deleting field 'DecizieCotizatie.data_sfarsit'
        db.delete_column('documente_deciziecotizatie', 'data_sfarsit')
