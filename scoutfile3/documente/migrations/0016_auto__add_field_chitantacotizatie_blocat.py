...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChitantaCotizatie.blocat'
        db.add_column('documente_chitantacotizatie', 'blocat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChitantaCotizatie.blocat'
        db.delete_column('documente_chitantacotizatie', 'blocat')
