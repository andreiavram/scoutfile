...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SerieDocument.data_inceput'
        db.add_column('documente_seriedocument', 'data_inceput',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Document.numar_inregistrare'
        db.add_column('documente_document', 'numar_inregistrare',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SerieDocument.data_inceput'
        db.delete_column('documente_seriedocument', 'data_inceput')

        # Deleting field 'Document.numar_inregistrare'
        db.delete_column('documente_document', 'numar_inregistrare')
    ...
    models = {
        ...
        'documente.document': {
            ...
            'numar_inregistrare': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
