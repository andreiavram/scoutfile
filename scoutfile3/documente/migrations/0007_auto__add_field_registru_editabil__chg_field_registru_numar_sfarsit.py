...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registru.editabil'
        db.add_column('documente_registru', 'editabil',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Registru.numar_sfarsit'
        db.alter_column('documente_registru', 'numar_sfarsit', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Registru.editabil'
        db.delete_column('documente_registru', 'editabil')


        # Changing field 'Registru.numar_sfarsit'
        db.alter_column('documente_registru', 'numar_sfarsit', self.gf('django.db.models.fields.IntegerField')(default=None))
