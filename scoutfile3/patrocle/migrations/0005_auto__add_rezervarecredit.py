...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RezervareCredit'
        db.create_table('patrocle_rezervarecredit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('credit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patrocle.Credit'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('patrocle', ['RezervareCredit'])


    def backwards(self, orm):
        
        # Deleting model 'RezervareCredit'
        db.delete_table('patrocle_rezervarecredit')
