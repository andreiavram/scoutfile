...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsociereMembruStructura.confirmata'
        db.add_column('structuri_asocieremembrustructura', 'confirmata', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AsociereMembruStructura.confirmata_pe'
        db.add_column('structuri_asocieremembrustructura', 'confirmata_pe', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'AsociereMembruStructura.confirmata_de'
        db.add_column('structuri_asocieremembrustructura', 'confirmata_de', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='asocieri_confirmate', null=True, to=orm['structuri.Utilizator']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AsociereMembruStructura.confirmata'
        db.delete_column('structuri_asocieremembrustructura', 'confirmata')

        # Deleting field 'AsociereMembruStructura.confirmata_pe'
        db.delete_column('structuri_asocieremembrustructura', 'confirmata_pe')

        # Deleting field 'AsociereMembruStructura.confirmata_de'
        db.delete_column('structuri_asocieremembrustructura', 'confirmata_de_id')
