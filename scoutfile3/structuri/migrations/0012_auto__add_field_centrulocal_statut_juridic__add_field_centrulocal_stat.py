...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CentruLocal.statut_juridic'
        db.add_column('structuri_centrulocal', 'statut_juridic', self.gf('django.db.models.fields.CharField')(default='nopj', max_length=255), keep_default=False)

        # Adding field 'CentruLocal.statut_drepturi'
        db.add_column('structuri_centrulocal', 'statut_drepturi', self.gf('django.db.models.fields.CharField')(default='depline', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CentruLocal.statut_juridic'
        db.delete_column('structuri_centrulocal', 'statut_juridic')

        # Deleting field 'CentruLocal.statut_drepturi'
        db.delete_column('structuri_centrulocal', 'statut_drepturi')
