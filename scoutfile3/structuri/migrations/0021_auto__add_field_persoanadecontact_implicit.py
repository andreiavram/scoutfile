...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersoanaDeContact.implicit'
        db.add_column('structuri_persoanadecontact', 'implicit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersoanaDeContact.implicit'
        db.delete_column('structuri_persoanadecontact', 'implicit')
