...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field content_types on 'TipAsociereMembruStructura'
        db.create_table('structuri_tipasocieremembrustructura_content_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tipasocieremembrustructura', models.ForeignKey(orm['structuri.tipasocieremembrustructura'], null=False)),
            ('contenttype', models.ForeignKey(orm['contenttypes.contenttype'], null=False))
        ))
        db.create_unique('structuri_tipasocieremembrustructura_content_types', ['tipasocieremembrustructura_id', 'contenttype_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field content_types on 'TipAsociereMembruStructura'
        db.delete_table('structuri_tipasocieremembrustructura_content_types')
