...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patrula.moment_inchidere'
        db.add_column('structuri_patrula', 'moment_inchidere',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patrula.moment_inchidere'
        db.delete_column('structuri_patrula', 'moment_inchidere')
