...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membru.centru_local'
        db.delete_column('structuri_membru', 'centru_local_id')


    def backwards(self, orm):
        
        # Adding field 'Membru.centru_local'
        db.add_column('structuri_membru', 'centru_local', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.CentruLocal'], null=True, blank=True), keep_default=False)
