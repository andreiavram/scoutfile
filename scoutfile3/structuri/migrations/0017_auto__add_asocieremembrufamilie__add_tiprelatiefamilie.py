...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AsociereMembruFamilie'
        db.create_table('structuri_asocieremembrufamilie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tip_relatie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.TipRelatieFamilie'])),
            ('persoana_sursa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
            ('persoana_destinatie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membru_destinatie', to=orm['structuri.Membru'])),
        ))
        db.send_create_signal('structuri', ['AsociereMembruFamilie'])

        # Adding model 'TipRelatieFamilie'
        db.create_table('structuri_tiprelatiefamilie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nume', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('structuri', ['TipRelatieFamilie'])


    def backwards(self, orm):
        
        # Deleting model 'AsociereMembruFamilie'
        db.delete_table('structuri_asocieremembrufamilie')

        # Deleting model 'TipRelatieFamilie'
        db.delete_table('structuri_tiprelatiefamilie')
