...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PersoanaDeContact'
        db.create_table('structuri_persoanadecontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nume', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('tip_relatie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.TipRelatieFamilie'], null=True, blank=True)),
            ('telefon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('job', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
        ))
        db.send_create_signal('structuri', ['PersoanaDeContact'])


    def backwards(self, orm):
        
        # Deleting model 'PersoanaDeContact'
        db.delete_table('structuri_persoanadecontact')
