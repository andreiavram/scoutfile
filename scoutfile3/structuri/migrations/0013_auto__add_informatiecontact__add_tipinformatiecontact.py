...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InformatieContact'
        db.create_table('structuri_informatiecontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tip_informatie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.TipInformatieContact'])),
            ('valoare', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('data_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('data_end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('obiect_ref_ctype', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='referit', null=True, to=orm['contenttypes.ContentType'])),
            ('obiect_ref_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['InformatieContact'])

        # Adding model 'TipInformatieContact'
        db.create_table('structuri_tipinformatiecontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('descriere', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('relevanta', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['TipInformatieContact'])


    def backwards(self, orm):
        
        # Deleting model 'InformatieContact'
        db.delete_table('structuri_informatiecontact')

        # Deleting model 'TipInformatieContact'
        db.delete_table('structuri_tipinformatiecontact')
