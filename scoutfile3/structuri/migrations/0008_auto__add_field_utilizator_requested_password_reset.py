...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Utilizator.requested_password_reset'
        db.add_column('structuri_utilizator', 'requested_password_reset', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Utilizator.requested_password_reset'
        db.delete_column('structuri_utilizator', 'requested_password_reset')
