...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CentruLocal.preferinte_corespondenta'
        db.add_column('structuri_centrulocal', 'preferinte_corespondenta', self.gf('django.db.models.fields.CharField')(default='email', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CentruLocal.preferinte_corespondenta'
        db.delete_column('structuri_centrulocal', 'preferinte_corespondenta')
