...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RamuraDeVarsta.are_patrule'
        db.add_column('structuri_ramuradevarsta', 'are_patrule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RamuraDeVarsta.are_patrule'
        db.delete_column('structuri_ramuradevarsta', 'are_patrule')
