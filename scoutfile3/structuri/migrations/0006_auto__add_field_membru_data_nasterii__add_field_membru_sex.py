...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membru.data_nasterii'
        db.add_column('structuri_membru', 'data_nasterii', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Membru.sex'
        db.add_column('structuri_membru', 'sex', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membru.data_nasterii'
        db.delete_column('structuri_membru', 'data_nasterii')

        # Deleting field 'Membru.sex'
        db.delete_column('structuri_membru', 'sex')
