...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('utils_facebooksession', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ...
        db.send_create_signal('utils', ['FacebookSession'])


    def backwards(self, orm):
        # Deleting model 'FacebookSession'
        db.delete_table('utils_facebooksession')
    ...
    models = {
        ...
        'utils.facebooksession': {
            'Meta': {'object_name': 'FacebookSession'},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
