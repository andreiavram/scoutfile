...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategorieFiseActivitate'
        db.create_table('jocuri_categoriefiseactivitate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nume', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('jocuri', ['CategorieFiseActivitate'])

        # Adding model 'FisaActivitate'
        db.create_table('jocuri_fisaactivitate', (
            ...
            ('materiale_necesare', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('min_participanti', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_participanti', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('min_durata', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_durata', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('obiective_educative', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jocuri.CategorieFiseActivitate'])),
            ('sursa', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('jocuri', ['FisaActivitate'])

        # Adding M2M table for field ramuri_de_varsta on 'FisaActivitate'
        m2m_table_name = db.shorten_name('jocuri_fisaactivitate_ramuri_de_varsta')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fisaactivitate', models.ForeignKey(orm['jocuri.fisaactivitate'], null=False)),
            ('ramuradevarsta', models.ForeignKey(orm['structuri.ramuradevarsta'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fisaactivitate_id', 'ramuradevarsta_id'])


    def backwards(self, orm):
        # Deleting model 'CategorieFiseActivitate'
        db.delete_table('jocuri_categoriefiseactivitate')

        # Deleting model 'FisaActivitate'
        db.delete_table('jocuri_fisaactivitate')

        # Removing M2M table for field ramuri_de_varsta on 'FisaActivitate'
        db.delete_table(db.shorten_name('jocuri_fisaactivitate_ramuri_de_varsta'))
