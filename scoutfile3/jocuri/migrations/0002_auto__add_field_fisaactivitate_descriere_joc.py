...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FisaActivitate.descriere_joc'
        db.add_column('jocuri_fisaactivitate', 'descriere_joc',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FisaActivitate.descriere_joc'
        db.delete_column('jocuri_fisaactivitate', 'descriere_joc')
