...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('badge_badge', (
            ...
            ('tiraj', self.gf('django.db.models.fields.IntegerField')()),
            ('tiraj_exact', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('producator', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('designer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('designer_membru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'], null=True, blank=True)),
            ('data_productie', self.gf('django.db.models.fields.DateField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='produs', max_length=255)),
            ('poza_badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Imagine'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'badge.badge': {
            ...
            'data_productie': ('django.db.models.fields.DateField', [], {}),
            'designer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'designer_membru': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['structuri.Membru']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nume': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'poza_badge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['album.Imagine']", 'null': 'True', 'blank': 'True'}),
            'producator': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'produs'", 'max_length': '255'}),
            'tip': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'tiraj': ('django.db.models.fields.IntegerField', [], {}),
            'tiraj_exact': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
