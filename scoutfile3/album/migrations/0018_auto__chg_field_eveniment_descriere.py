...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Eveniment.descriere'
        db.alter_column('album_eveniment', 'descriere', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Eveniment.descriere'
        db.alter_column('album_eveniment', 'descriere', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
