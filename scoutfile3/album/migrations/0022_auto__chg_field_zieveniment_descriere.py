...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ZiEveniment.descriere'
        db.alter_column('album_zieveniment', 'descriere', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ZiEveniment.descriere'
        db.alter_column('album_zieveniment', 'descriere', self.gf('django.db.models.fields.CharField')(default='', max_length=1024))
