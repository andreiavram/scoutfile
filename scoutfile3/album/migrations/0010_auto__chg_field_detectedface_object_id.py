...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetectedFace.object_id'
        db.alter_column('album_detectedface', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DetectedFace.object_id'
        db.alter_column('album_detectedface', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
