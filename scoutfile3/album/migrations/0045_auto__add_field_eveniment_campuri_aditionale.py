...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.campuri_aditionale'
        db.add_column('album_eveniment', 'campuri_aditionale',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.campuri_aditionale'
        db.delete_column('album_eveniment', 'campuri_aditionale')
