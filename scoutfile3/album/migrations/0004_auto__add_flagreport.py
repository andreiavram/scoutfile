...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlagReport'
        db.create_table('album_flagreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('imagine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Imagine'])),
            ('motiv', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('alt_motiv', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('album', ['FlagReport'])


    def backwards(self, orm):
        
        # Deleting model 'FlagReport'
        db.delete_table('album_flagreport')
