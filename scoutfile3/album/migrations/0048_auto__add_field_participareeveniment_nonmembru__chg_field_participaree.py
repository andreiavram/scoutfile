...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipareEveniment.nonmembru'
        db.add_column('album_participareeveniment', 'nonmembru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.ParticipantEveniment'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ParticipareEveniment.membru'
        db.alter_column('album_participareeveniment', 'membru_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'], null=True))

    def backwards(self, orm):
        # Deleting field 'ParticipareEveniment.nonmembru'
        db.delete_column('album_participareeveniment', 'nonmembru_id')


        # User chose to not deal with backwards NULL issues for 'ParticipareEveniment.membru'
        raise RuntimeError("Cannot reverse this migration. 'ParticipareEveniment.membru' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ParticipareEveniment.membru'
        db.alter_column('album_participareeveniment', 'membru_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru']))
    ...
    models = {
        ...
        'album.participareeveniment': {
            ...
            'eveniment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['album.Eveniment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membru': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['structuri.Membru']", 'null': 'True', 'blank': 'True'}),
            'nonmembru': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['album.ParticipantEveniment']", 'null': 'True', 'blank': 'True'}),
