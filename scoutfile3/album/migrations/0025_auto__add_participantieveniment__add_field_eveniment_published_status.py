...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantiEveniment'
        db.create_table('album_participantieveniment', (
            ...
            ('numar', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('album', ['ParticipantiEveniment'])

        # Adding field 'Eveniment.published_status'
        db.add_column('album_eveniment', 'published_status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ParticipantiEveniment'
        db.delete_table('album_participantieveniment')

        # Deleting field 'Eveniment.published_status'
        db.delete_column('album_eveniment', 'published_status')
