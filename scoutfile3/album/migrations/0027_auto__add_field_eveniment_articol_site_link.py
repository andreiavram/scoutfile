...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.articol_site_link'
        db.add_column('album_eveniment', 'articol_site_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.articol_site_link'
        db.delete_column('album_eveniment', 'articol_site_link')
