...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.custom_cover_photo'
        db.add_column('album_eveniment', 'custom_cover_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Imagine'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.custom_cover_photo'
        db.delete_column('album_eveniment', 'custom_cover_photo_id')
