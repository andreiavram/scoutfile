...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.international'
        db.add_column('album_eveniment', 'international',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Eveniment.organizator'
        db.add_column('album_eveniment', 'organizator',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Eveniment.organizator_cercetas'
        db.add_column('album_eveniment', 'organizator_cercetas',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.international'
        db.delete_column('album_eveniment', 'international')

        # Deleting field 'Eveniment.organizator'
        db.delete_column('album_eveniment', 'organizator')

        # Deleting field 'Eveniment.organizator_cercetas'
        db.delete_column('album_eveniment', 'organizator_cercetas')
