...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetectedFace'
        db.create_table('album_detectedface', (
            ...
            ('heigth', self.gf('django.db.models.fields.IntegerField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('album', ['DetectedFace'])

        # Adding field 'Imagine.is_face_processed'
        db.add_column('album_imagine', 'is_face_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DetectedFace'
        db.delete_table('album_detectedface')

        # Deleting field 'Imagine.is_face_processed'
        db.delete_column('album_imagine', 'is_face_processed')
    ...
    models = {
        'album.detectedface': {
            ...
            'heigth': ('django.db.models.fields.IntegerField', [], {}),
