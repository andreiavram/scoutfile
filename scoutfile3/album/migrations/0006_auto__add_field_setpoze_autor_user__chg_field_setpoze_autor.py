...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPoze.autor_user'
        db.add_column('album_setpoze', 'autor_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'SetPoze.autor'
        db.alter_column('album_setpoze', 'autor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'SetPoze.autor_user'
        db.delete_column('album_setpoze', 'autor_user_id')


        # Changing field 'SetPoze.autor'
        db.alter_column('album_setpoze', 'autor', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
