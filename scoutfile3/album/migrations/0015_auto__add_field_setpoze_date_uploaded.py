...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPoze.date_uploaded'
        db.add_column('album_setpoze', 'date_uploaded',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetPoze.date_uploaded'
        db.delete_column('album_setpoze', 'date_uploaded')
