...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RaportEveniment'
        db.create_table('album_raporteveniment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parteneri', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('obiective', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('grup_tinta', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('activitati', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('alti_beneficiari', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('promovare', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('buget', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('accept_publicare_raport_national', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('original_parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.RaportEveniment'], null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', to=orm['album.RaportEveniment'])),
        ))
        db.send_create_signal('album', ['RaportEveniment'])


    def backwards(self, orm):
        # Deleting model 'RaportEveniment'
        db.delete_table('album_raporteveniment')
    ...
    models = {
        ...
        'album.eveniment': {
            ...
            'ramuri_de_varsta': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['structuri.RamuraDeVarsta']", 'null': 'True', 'through': "orm['album.ParticipantiEveniment']", 'blank': 'True'}),
        ...
        'album.raporteveniment': {
            'Meta': {'object_name': 'RaportEveniment'},
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'children'", 'to': "orm['album.RaportEveniment']"}),
