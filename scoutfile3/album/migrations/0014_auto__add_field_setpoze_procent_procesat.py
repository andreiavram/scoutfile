...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPoze.procent_procesat'
        db.add_column('album_setpoze', 'procent_procesat',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetPoze.procent_procesat'
        db.delete_column('album_setpoze', 'procent_procesat')
