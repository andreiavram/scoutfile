...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.tip_eveniment'
        db.add_column('album_eveniment', 'tip_eveniment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['album.TipEveniment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.tip_eveniment'
        db.delete_column('album_eveniment', 'tip_eveniment_id')
    ...
    models = {
        ...
        'album.eveniment': {
            ...
            'tip_eveniment_text': ('django.db.models.fields.CharField', [], {'default': "'propus'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'album.exifdata': {
