...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Eveniment.slug'
        db.alter_column('album_eveniment', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))
        # Adding index on 'Eveniment', fields ['slug']
        db.create_index('album_eveniment', ['slug'])

        # Adding unique constraint on 'Eveniment', fields ['slug']
        db.create_unique('album_eveniment', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Eveniment', fields ['slug']
        db.delete_unique('album_eveniment', ['slug'])

        # Removing index on 'Eveniment', fields ['slug']
        db.delete_index('album_eveniment', ['slug'])


        # Changing field 'Eveniment.slug'
        db.alter_column('album_eveniment', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
