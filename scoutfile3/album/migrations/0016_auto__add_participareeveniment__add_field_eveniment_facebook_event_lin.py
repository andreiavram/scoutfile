...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipareEveniment'
        db.create_table('album_participareeveniment', (
            ...
            ('data_sosire', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('data_plecare', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('status_participare', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('album', ['ParticipareEveniment'])

        # Adding field 'Eveniment.facebook_event_link'
        db.add_column('album_eveniment', 'facebook_event_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ParticipareEveniment'
        db.delete_table('album_participareeveniment')

        # Deleting field 'Eveniment.facebook_event_link'
        db.delete_column('album_eveniment', 'facebook_event_link')
