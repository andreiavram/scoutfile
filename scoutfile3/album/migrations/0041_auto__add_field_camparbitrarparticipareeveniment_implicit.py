...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampArbitrarParticipareEveniment.implicit'
        db.add_column('album_camparbitrarparticipareeveniment', 'implicit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampArbitrarParticipareEveniment.implicit'
        db.delete_column('album_camparbitrarparticipareeveniment', 'implicit')
