...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampArbitrarParticipareEveniment.nume'
        db.add_column('album_camparbitrarparticipareeveniment', 'nume',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'CampArbitrarParticipareEveniment.slug'
        db.add_column('album_camparbitrarparticipareeveniment', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'CampArbitrarParticipareEveniment.optional'
        db.add_column('album_camparbitrarparticipareeveniment', 'optional',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampArbitrarParticipareEveniment.nume'
        db.delete_column('album_camparbitrarparticipareeveniment', 'nume')

        # Deleting field 'CampArbitrarParticipareEveniment.slug'
        db.delete_column('album_camparbitrarparticipareeveniment', 'slug')

        # Deleting field 'CampArbitrarParticipareEveniment.optional'
        db.delete_column('album_camparbitrarparticipareeveniment', 'optional')
