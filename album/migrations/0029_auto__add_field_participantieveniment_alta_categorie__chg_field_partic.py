...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantiEveniment.alta_categorie'
        db.add_column('album_participantieveniment', 'alta_categorie',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ParticipantiEveniment.ramura_de_varsta'
        db.alter_column('album_participantieveniment', 'ramura_de_varsta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.RamuraDeVarsta'], null=True))

    def backwards(self, orm):
        # Deleting field 'ParticipantiEveniment.alta_categorie'
        db.delete_column('album_participantieveniment', 'alta_categorie')


        # User chose to not deal with backwards NULL issues for 'ParticipantiEveniment.ramura_de_varsta'
        raise RuntimeError("Cannot reverse this migration. 'ParticipantiEveniment.ramura_de_varsta' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ParticipantiEveniment.ramura_de_varsta'
        db.alter_column('album_participantieveniment', 'ramura_de_varsta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.RamuraDeVarsta']))
