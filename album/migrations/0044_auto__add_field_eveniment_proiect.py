...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.proiect'
        db.add_column('album_eveniment', 'proiect',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['proiecte.Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.proiect'
        db.delete_column('album_eveniment', 'proiect_id')
