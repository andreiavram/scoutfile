...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eveniment.responsabil_raport'
        db.add_column('album_eveniment', 'responsabil_raport',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='evenimente_raport', null=True, to=orm['structuri.Membru']),
                      keep_default=False)

        # Adding field 'Eveniment.responsabil_articol'
        db.add_column('album_eveniment', 'responsabil_articol',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='evenimente_articol', null=True, to=orm['structuri.Membru']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eveniment.responsabil_raport'
        db.delete_column('album_eveniment', 'responsabil_raport_id')

        # Deleting field 'Eveniment.responsabil_articol'
        db.delete_column('album_eveniment', 'responsabil_articol_id')
