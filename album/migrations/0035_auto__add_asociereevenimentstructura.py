...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AsociereEvenimentStructura'
        db.create_table('album_asociereevenimentstructura', (
        ...
        db.send_create_signal('album', ['AsociereEvenimentStructura'])


    def backwards(self, orm):
        # Deleting model 'AsociereEvenimentStructura'
        db.delete_table('album_asociereevenimentstructura')
