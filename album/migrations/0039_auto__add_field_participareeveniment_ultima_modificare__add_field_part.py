...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipareEveniment.ultima_modificare'
        db.add_column('album_participareeveniment', 'ultima_modificare',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 21, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ParticipareEveniment.user_modificare'
        db.add_column('album_participareeveniment', 'user_modificare',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='participari_responsabil', null=True, to=orm['structuri.Membru']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipareEveniment.ultima_modificare'
        db.delete_column('album_participareeveniment', 'ultima_modificare')

        # Deleting field 'ParticipareEveniment.user_modificare'
        db.delete_column('album_participareeveniment', 'user_modificare_id')
