...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampArbitrarParticipareEveniment.explicatii_suplimentare'
        db.add_column('album_camparbitrarparticipareeveniment', 'explicatii_suplimentare',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampArbitrarParticipareEveniment.explicatii_suplimentare'
        db.delete_column('album_camparbitrarparticipareeveniment', 'explicatii_suplimentare')
