...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZiEveniment.index'
        db.add_column('album_zieveniment', 'index', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZiEveniment.index'
        db.delete_column('album_zieveniment', 'index')
