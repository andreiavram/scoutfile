...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPoze.zip_file'
        db.add_column('album_setpoze', 'zip_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SetPoze.status'
        db.add_column('album_setpoze', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetPoze.zip_file'
        db.delete_column('album_setpoze', 'zip_file')

        # Deleting field 'SetPoze.status'
        db.delete_column('album_setpoze', 'status')
