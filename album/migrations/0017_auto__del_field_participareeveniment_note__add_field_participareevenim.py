...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParticipareEveniment.note'
        db.delete_column('album_participareeveniment', 'note')

        # Adding field 'ParticipareEveniment.detalii'
        db.add_column('album_participareeveniment', 'detalii',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Eveniment.locatie_text'
        db.add_column('album_eveniment', 'locatie_text',
    ...
    def backwards(self, orm):
        # Adding field 'ParticipareEveniment.note'
        db.add_column('album_participareeveniment', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ParticipareEveniment.detalii'
        db.delete_column('album_participareeveniment', 'detalii')

        # Deleting field 'Eveniment.locatie_text'
        db.delete_column('album_eveniment', 'locatie_text')
    ...
    models = {
        ...
        'album.eveniment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locatie_lat': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'locatie_long': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        'album.setpoze': {
            ...
            'procent_procesat': ('django.db.models.fields.IntegerField', [], {}),
