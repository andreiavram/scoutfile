...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstantaCampArbitrarParticipareEveniment'
        db.create_table('album_instantacamparbitrarparticipareeveniment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('camp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.CampArbitrarParticipareEveniment'])),
            ('participare', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.ParticipareEveniment'])),
            ('valoare_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('album', ['InstantaCampArbitrarParticipareEveniment'])

        # Adding model 'CampArbitrarParticipareEveniment'
        db.create_table('album_camparbitrarparticipareeveniment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('eveniment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Eveniment'])),
            ('tip_camp', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('album', ['CampArbitrarParticipareEveniment'])

        # Adding field 'ParticipareEveniment.rol'
        db.add_column('album_participareeveniment', 'rol',
                      self.gf('django.db.models.fields.CharField')(default='participant', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstantaCampArbitrarParticipareEveniment'
        db.delete_table('album_instantacamparbitrarparticipareeveniment')

        # Deleting model 'CampArbitrarParticipareEveniment'
        db.delete_table('album_camparbitrarparticipareeveniment')

        # Deleting field 'ParticipareEveniment.rol'
        db.delete_column('album_participareeveniment', 'rol')
    ...
    models = {
        ...
        'album.eveniment': {
            ...
            'tip_eveniment': ('django.db.models.fields.CharField', [], {'default': "'propus'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'album.exifdata': {
        ...
        'album.instantacamparbitrarparticipareeveniment': {
            ...
            'camp': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['album.CampArbitrarParticipareEveniment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
