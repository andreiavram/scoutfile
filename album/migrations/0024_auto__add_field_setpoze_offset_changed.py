...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPoze.offset_changed'
        db.add_column('album_setpoze', 'offset_changed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetPoze.offset_changed'
        db.delete_column('album_setpoze', 'offset_changed')
