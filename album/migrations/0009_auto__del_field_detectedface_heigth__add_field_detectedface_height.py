...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetectedFace.heigth'
        db.delete_column('album_detectedface', 'heigth')

        # Adding field 'DetectedFace.height'
        db.add_column('album_detectedface', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetectedFace.heigth'
        db.add_column('album_detectedface', 'heigth',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DetectedFace.height'
        db.delete_column('album_detectedface', 'height')
