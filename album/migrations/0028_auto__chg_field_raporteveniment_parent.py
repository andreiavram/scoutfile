...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RaportEveniment.parent'
        db.alter_column('album_raporteveniment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['album.RaportEveniment']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RaportEveniment.parent'
        raise RuntimeError("Cannot reverse this migration. 'RaportEveniment.parent' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RaportEveniment.parent'
        db.alter_column('album_raporteveniment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.RaportEveniment']))
