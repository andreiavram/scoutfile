...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Imagine.descriere'
        db.alter_column('album_imagine', 'descriere', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Imagine.descriere'
        db.alter_column('album_imagine', 'descriere', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
