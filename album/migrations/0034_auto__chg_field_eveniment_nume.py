...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Eveniment.nume'
        db.alter_column('album_eveniment', 'nume', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Eveniment.nume'
        db.alter_column('album_eveniment', 'nume', self.gf('django.db.models.fields.CharField')(max_length=255))
