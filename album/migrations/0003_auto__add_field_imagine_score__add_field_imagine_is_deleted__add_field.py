...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Imagine.score'
        db.add_column('album_imagine', 'score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Imagine.is_deleted'
        db.add_column('album_imagine', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Imagine.is_flagged'
        db.add_column('album_imagine', 'is_flagged', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Imagine.score'
        db.delete_column('album_imagine', 'score')

        # Deleting field 'Imagine.is_deleted'
        db.delete_column('album_imagine', 'is_deleted')

        # Deleting field 'Imagine.is_flagged'
        db.delete_column('album_imagine', 'is_flagged')
