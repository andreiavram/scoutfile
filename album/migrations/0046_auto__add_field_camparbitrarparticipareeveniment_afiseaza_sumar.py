...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampArbitrarParticipareEveniment.afiseaza_sumar'
        db.add_column('album_camparbitrarparticipareeveniment', 'afiseaza_sumar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampArbitrarParticipareEveniment.afiseaza_sumar'
        db.delete_column('album_camparbitrarparticipareeveniment', 'afiseaza_sumar')
