...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipEveniment'
        db.create_table('album_tipeveniment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nume', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('album', ['TipEveniment'])


    def backwards(self, orm):
        # Deleting model 'TipEveniment'
        db.delete_table('album_tipeveniment')
