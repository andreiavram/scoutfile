...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Imagine.published_status'
        db.add_column('album_imagine', 'published_status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Imagine.published_status'
        db.delete_column('album_imagine', 'published_status')
