...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Imagine.set_poze'
        db.alter_column('album_imagine', 'set_poze_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.SetPoze'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Imagine.set_poze'
        raise RuntimeError("Cannot reverse this migration. 'Imagine.set_poze' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Imagine.set_poze'
        db.alter_column('album_imagine', 'set_poze_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.SetPoze']))
