...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SetPoze.zip_file'
        db.alter_column('album_setpoze', 'zip_file', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/tmp', null=True))

    def backwards(self, orm):

        # Changing field 'SetPoze.zip_file'
        db.alter_column('album_setpoze', 'zip_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
