...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field editori on 'FisaActivitate'
        m2m_table_name = db.shorten_name('jocuri_fisaactivitate_editori')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fisaactivitate', models.ForeignKey(orm['jocuri.fisaactivitate'], null=False)),
            ('membru', models.ForeignKey(orm['structuri.membru'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fisaactivitate_id', 'membru_id'])


    def backwards(self, orm):
        # Removing M2M table for field editori on 'FisaActivitate'
        db.delete_table(db.shorten_name('jocuri_fisaactivitate_editori'))
