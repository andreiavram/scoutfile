...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.disponibil_in'
        db.add_column('badge_badge', 'disponibil_in',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.disponibil_in'
        db.delete_column('badge_badge', 'disponibil_in')
    ...
    models = {
        ...
        'badge.badge': {
            ...
            'disponibil_in': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nume': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
