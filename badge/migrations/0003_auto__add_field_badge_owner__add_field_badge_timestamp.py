...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.owner'
        db.add_column('badge_badge', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='badgeuri', to=orm['structuri.Membru']),
                      keep_default=False)

        # Adding field 'Badge.timestamp'
        db.add_column('badge_badge', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 10, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.owner'
        db.delete_column('badge_badge', 'owner_id')

        # Deleting field 'Badge.timestamp'
        db.delete_column('badge_badge', 'timestamp')
    ...
    models = {
        ...
        'badge.badge': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nume': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'badgeuri'", 'to': "orm['structuri.Membru']"}),
