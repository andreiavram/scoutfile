...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChitantaCotizatie.predat'
        db.add_column('documente_chitantacotizatie', 'predat',
    ...
    def backwards(self, orm):
        # Deleting field 'ChitantaCotizatie.predat'
        db.delete_column('documente_chitantacotizatie', 'predat')

        # Adding field 'PlataCotizatieTrimestru.casa'
        db.add_column('documente_platacotizatietrimestru', 'casa',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='incasari_cotizatii', to=orm['structuri.Membru']),
                      keep_default=False)
