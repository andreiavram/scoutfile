...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChitantaCotizatie'
        db.create_table('documente_chitantacotizatie', (
            ('chitanta_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documente.Chitanta'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('documente', ['ChitantaCotizatie'])

        # Adding model 'Chitanta'
        db.create_table('documente_chitanta', (
            ...
            ('casier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
            ('suma', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('documente', ['Chitanta'])

        # Adding model 'TipDocument'
        db.create_table('documente_tipdocument', (
        ...
        db.send_create_signal('documente', ['TipDocument'])

        # Adding field 'Document.fragment'
        db.add_column('documente_document', 'fragment',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Document.tip_document'
        db.add_column('documente_document', 'tip_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.TipDocument'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ChitantaCotizatie'
        db.delete_table('documente_chitantacotizatie')

        # Deleting model 'Chitanta'
        db.delete_table('documente_chitanta')

        # Deleting model 'TipDocument'
        db.delete_table('documente_tipdocument')

        # Deleting field 'Document.fragment'
        db.delete_column('documente_document', 'fragment')

        # Deleting field 'Document.tip_document'
        db.delete_column('documente_document', 'tip_document_id')
