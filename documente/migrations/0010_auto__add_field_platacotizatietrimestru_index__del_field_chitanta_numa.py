...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlataCotizatieTrimestru.index'
        db.add_column('documente_platacotizatietrimestru', 'index',
    ...
    def backwards(self, orm):
        # Deleting field 'PlataCotizatieTrimestru.index'
        db.delete_column('documente_platacotizatietrimestru', 'index')
