...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registru.descriere'
        db.add_column('documente_registru', 'descriere',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registru.descriere'
        db.delete_column('documente_registru', 'descriere')
