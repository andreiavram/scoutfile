...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Registru'
        db.create_table('documente_registru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('centru_local', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.CentruLocal'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Membru'])),
            ('mod_functionare', self.gf('django.db.models.fields.CharField')(default='auto', max_length=255)),
            ('tip_registru', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('document_referinta', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='registru_referinta', null=True, to=orm['documente.Document'])),
            ('serie', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('numar_inceput', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('numar_sfarsit', self.gf('django.db.models.fields.IntegerField')()),
            ('numar_curent', self.gf('django.db.models.fields.IntegerField')()),
            ('valabil', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('data_inceput', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('documente', ['Registru'])

        # Adding field 'Document.registru'
        db.add_column('documente_document', 'registru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.Registru'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Document.numar_inregistrare'
        db.alter_column('documente_document', 'numar_inregistrare', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Registru'
        db.delete_table('documente_registru')

        # Deleting field 'Document.registru'
        db.delete_column('documente_document', 'registru_id')


        # Changing field 'Document.numar_inregistrare'
        db.alter_column('documente_document', 'numar_inregistrare', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'documente.registru': {
            ...
            'valabil': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
