...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trimestru'
        db.create_table('documente_trimestru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data_inceput', self.gf('django.db.models.fields.DateField')()),
            ('date_sfarsit', self.gf('django.db.models.fields.DateField')()),
            ('ordine_global', self.gf('django.db.models.fields.IntegerField')()),
            ('ordine_local', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('documente', ['Trimestru'])

        # Adding field 'Chitanta.serie'
        db.add_column('documente_chitanta', 'serie',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Chitanta.numar'
        db.add_column('documente_chitanta', 'numar',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Trimestru'
        db.delete_table('documente_trimestru')

        # Deleting field 'Chitanta.serie'
        db.delete_column('documente_chitanta', 'serie')

        # Deleting field 'Chitanta.numar'
        db.delete_column('documente_chitanta', 'numar')
    ...
    models = {
        ...
        'documente.trimestru': {
            ...
            'date_sfarsit': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordine_global': ('django.db.models.fields.IntegerField', [], {}),
            'ordine_local': ('django.db.models.fields.IntegerField', [], {})
        },
