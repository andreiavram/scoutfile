...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RamuraDeVarsta.culoare'
        db.add_column('structuri_ramuradevarsta', 'culoare',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RamuraDeVarsta.culoare'
        db.delete_column('structuri_ramuradevarsta', 'culoare')
