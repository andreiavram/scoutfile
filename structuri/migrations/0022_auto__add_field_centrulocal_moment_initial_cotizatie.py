...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CentruLocal.moment_initial_cotizatie'
        db.add_column('structuri_centrulocal', 'moment_initial_cotizatie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documente.Trimestru'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CentruLocal.moment_initial_cotizatie'
        db.delete_column('structuri_centrulocal', 'moment_initial_cotizatie_id')
