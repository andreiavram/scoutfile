...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patrula.activa'
        db.add_column('structuri_patrula', 'activa',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CentruLocal.activa'
        db.add_column('structuri_centrulocal', 'activa',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Unitate.activa'
        db.add_column('structuri_unitate', 'activa',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patrula.activa'
        db.delete_column('structuri_patrula', 'activa')

        # Deleting field 'CentruLocal.activa'
        db.delete_column('structuri_centrulocal', 'activa')

        # Deleting field 'Unitate.activa'
        db.delete_column('structuri_unitate', 'activa')
