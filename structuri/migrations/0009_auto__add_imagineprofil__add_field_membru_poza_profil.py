...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImagineProfil'
        db.create_table('structuri_imagineprofil', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='imagineprofil_related', null=True, to=orm['photologue.PhotoEffect'])),
        ))
        db.send_create_signal('structuri', ['ImagineProfil'])

        # Adding field 'Membru.poza_profil'
        db.add_column('structuri_membru', 'poza_profil', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.ImagineProfil'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ImagineProfil'
        db.delete_table('structuri_imagineprofil')

        # Deleting field 'Membru.poza_profil'
        db.delete_column('structuri_membru', 'poza_profil_id')
