...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RamuraDeVarsta.slug'
        db.add_column('structuri_ramuradevarsta', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RamuraDeVarsta.slug'
        db.delete_column('structuri_ramuradevarsta', 'slug')
