...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipInformatieContact.is_sms_capable'
        db.add_column('structuri_tipinformatiecontact', 'is_sms_capable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TipInformatieContact.is_sms_capable'
        db.delete_column('structuri_tipinformatiecontact', 'is_sms_capable')
