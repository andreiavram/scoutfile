...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InformatieContact.implicita'
        db.add_column('structuri_informatiecontact', 'implicita',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InformatieContact.implicita'
        db.delete_column('structuri_informatiecontact', 'implicita')
