...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CentruLocal.logo'
        db.add_column('structuri_centrulocal', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CentruLocal.antet'
        db.add_column('structuri_centrulocal', 'antet',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CentruLocal.logo'
        db.delete_column('structuri_centrulocal', 'logo')

        # Deleting field 'CentruLocal.antet'
        db.delete_column('structuri_centrulocal', 'antet')
