...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipInformatieContact.adresa'
        db.add_column('structuri_tipinformatiecontact', 'adresa',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipInformatieContact.adresa'
        db.delete_column('structuri_tipinformatiecontact', 'adresa')
    ...
    models = {
        ...
        'structuri.informatiecontact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'implicita': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'structuri.tipinformatiecontact': {
            ...
            'adresa': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
