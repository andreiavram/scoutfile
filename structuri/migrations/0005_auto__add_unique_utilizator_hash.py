...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Utilizator', fields ['hash']
        db.create_unique('structuri_utilizator', ['hash'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Utilizator', fields ['hash']
        db.delete_unique('structuri_utilizator', ['hash'])
