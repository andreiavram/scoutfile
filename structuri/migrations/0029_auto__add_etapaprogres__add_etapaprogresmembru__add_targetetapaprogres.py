...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtapaProgres'
        db.create_table('structuri_etapaprogres', (
            ...
            ('logo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Imagine'])),
            ('ordine', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('reguli', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['EtapaProgres'])

        # Adding model 'EtapaProgresMembru'
        db.create_table('structuri_etapaprogresmembru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etapa_progres', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.EtapaProgres'])),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etape_progres', to=orm['structuri.Membru'])),
            ('evaluator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etape_progres_evaluate', to=orm['structuri.Membru'])),
            ('data', self.gf('django.db.models.fields.DateField')()),
            ('detalii', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['EtapaProgresMembru'])

        # Adding model 'TargetEtapaProgres'
        db.create_table('structuri_targetetapaprogres', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titlu', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('capitol', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('structuri', ['TargetEtapaProgres'])

        # Adding model 'ObiectivEducativProgres'
        db.create_table('structuri_obiectiveducativprogres', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titlu', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('descriere', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('domeniu', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pista', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['ObiectivEducativProgres'])

        # Adding model 'BadgeMeritMembru'
        db.create_table('structuri_badgemeritmembru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.BadgeMerit'])),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badgeuri_merit', to=orm['structuri.Membru'])),
            ('evaluator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badgeuri_merit_evaluate', to=orm['structuri.Membru'])),
            ('data', self.gf('django.db.models.fields.DateField')()),
            ('detalii', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['BadgeMeritMembru'])

        # Adding model 'NoteObiectivProgresMembru'
        db.create_table('structuri_noteobiectivprogresmembru', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('obiectiv', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.ObiectivEducativProgres'])),
            ('nota', self.gf('django.db.models.fields.TextField')()),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(related_name='note_obiective_progres', to=orm['structuri.Membru'])),
            ('evaluator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='note_obiective_progres_evaluate', to=orm['structuri.Membru'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('activitate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Eveniment'], null=True, blank=True)),
            ('obiectiv_atins', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('etapa_progres', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.EtapaProgres'])),
        ))
        db.send_create_signal('structuri', ['NoteObiectivProgresMembru'])

        # Adding model 'NotaTargetEtapaProgres'
        db.create_table('structuri_notatargetetapaprogres', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.TargetEtapaProgres'])),
            ('membru', self.gf('django.db.models.fields.related.ForeignKey')(related_name='note_etape_progres', to=orm['structuri.Membru'])),
            ('evaluator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='note_etape_progres_evaluate', to=orm['structuri.Membru'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('target_atins', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('activitate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Eveniment'], null=True, blank=True)),
        ))
        db.send_create_signal('structuri', ['NotaTargetEtapaProgres'])

        # Adding model 'BadgeMerit'
        db.create_table('structuri_badgemerit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ramura_de_varsta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.RamuraDeVarsta'], null=True, blank=True)),
            ('etapa_progres', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.EtapaProgres'], null=True, blank=True)),
            ('nume', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('descriere', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('logo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Imagine'])),
        ))
        db.send_create_signal('structuri', ['BadgeMerit'])


    def backwards(self, orm):
        # Deleting model 'EtapaProgres'
        db.delete_table('structuri_etapaprogres')

        # Deleting model 'EtapaProgresMembru'
        db.delete_table('structuri_etapaprogresmembru')

        # Deleting model 'TargetEtapaProgres'
        db.delete_table('structuri_targetetapaprogres')

        # Deleting model 'ObiectivEducativProgres'
        db.delete_table('structuri_obiectiveducativprogres')

        # Deleting model 'BadgeMeritMembru'
        db.delete_table('structuri_badgemeritmembru')

        # Deleting model 'NoteObiectivProgresMembru'
        db.delete_table('structuri_noteobiectivprogresmembru')

        # Deleting model 'NotaTargetEtapaProgres'
        db.delete_table('structuri_notatargetetapaprogres')

        # Deleting model 'BadgeMerit'
        db.delete_table('structuri_badgemerit')
