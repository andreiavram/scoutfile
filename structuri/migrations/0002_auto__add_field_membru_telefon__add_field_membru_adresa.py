...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membru.telefon'
        db.add_column('structuri_membru', 'telefon', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Membru.adresa'
        db.add_column('structuri_membru', 'adresa', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membru.telefon'
        db.delete_column('structuri_membru', 'telefon')

        # Deleting field 'Membru.adresa'
        db.delete_column('structuri_membru', 'adresa')
