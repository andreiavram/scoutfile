...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InformatieContact.informatii_suplimentare'
        db.add_column('structuri_informatiecontact', 'informatii_suplimentare', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InformatieContact.informatii_suplimentare'
        db.delete_column('structuri_informatiecontact', 'informatii_suplimentare')
