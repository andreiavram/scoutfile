...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membru.scor_credit'
        db.add_column('structuri_membru', 'scor_credit',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membru.scor_credit'
        db.delete_column('structuri_membru', 'scor_credit')
