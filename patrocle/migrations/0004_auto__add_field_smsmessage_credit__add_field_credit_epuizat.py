...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SMSMessage.credit'
        db.add_column('patrocle_smsmessage', 'credit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patrocle.Credit'], null=True, blank=True), keep_default=False)

        # Adding field 'Credit.epuizat'
        db.add_column('patrocle_credit', 'epuizat', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SMSMessage.credit'
        db.delete_column('patrocle_smsmessage', 'credit_id')

        # Deleting field 'Credit.epuizat'
        db.delete_column('patrocle_credit', 'epuizat')
