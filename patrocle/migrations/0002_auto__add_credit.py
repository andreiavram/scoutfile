...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Credit'
        db.create_table('patrocle_credit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('credit', self.gf('django.db.models.fields.IntegerField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('creat_de', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Utilizator'])),
            ('comentarii', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('tip', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('patrocle', ['Credit'])


    def backwards(self, orm):
        
        # Deleting model 'Credit'
        db.delete_table('patrocle_credit')
    ...
    models = {
        ...
        'patrocle.credit': {
            ...
            'creat_de': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['structuri.Utilizator']"}),
