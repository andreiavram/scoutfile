...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Credit.creat_de'
        db.alter_column('patrocle_credit', 'creat_de_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structuri.Utilizator'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Credit.creat_de'
        db.alter_column('patrocle_credit', 'creat_de_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['structuri.Utilizator']))
